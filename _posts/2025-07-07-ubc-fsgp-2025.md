...
2. Wet brake testing too slow (A note on integration here and the new brake plate)
    a. Rewrite the notes from Alex  
    b. Also, pots
...
### **Issue 3: Failing Wet Brake Testing A Few Times & Breaking The Accelerator Potentiometer**
