...
![Error Graph from our initial characterization of the current sensor](/assets/images/esp32-adc-characterization/initial-error.jpg)  
...
![My Initial Testing Setup](/assets/images/esp32-adc-characterization/test-setup.jpg)  
...
![STM32 ADC Voltage vs. True Voltage](/assets/images/esp32-adc-characterization/STM32-Multimeter-Testing.jpg)  
<i>Blue Line = ADC Observed Voltage, Red Line = True Voltage (what we expect), Yellow Line = ADC Voltage plus Error Polynomial</i>

![ESP32 ADC Voltage vs. True Voltage](/assets/images/esp32-adc-characterization/ESP32-Multimeter-Testing.jpg)  
<i>Blue Line = ADC Observed Voltage, Red Line = True Voltage (what we expect), Yellow Line = ADC Voltage plus Error Polynomial</i>
...
![Zoomed in view of the STM32 ADC Voltage vs. True Voltage](/assets/images/esp32-adc-characterization/STM32-Zoomed.jpg)  
...
![Testing with a 1.2 V Battery](/assets/images/esp32-adc-characterization/STM32-Battery-Testing.jpg)  
...
![This is the code from the Github repo I used, notice the massive array at the top that stores the lookup table.](/assets/images/esp32-adc-characterization/LUT.jpg)  
...
![Test Results](/assets/images/esp32-adc-characterization/LUT-Values.jpg)  
...
![Little difference was found between all the attenuation values.](/assets/images/esp32-adc-characterization/Atten-0-2.5.jpg)  
![Little difference was found between all the attenuation values.](/assets/images/esp32-adc-characterization/Atten-12.jpg)  
...
![I tested ADC 2 with lower-level functions and found little improvement.](/assets/images/esp32-adc-characterization/ADC2-raw-testing.jpg)  
...
![With the graphs above, I got the error graph and fit a Polynomial (trendline) to it](/assets/images/esp32-adc-characterization/Error-ADC2.jpg)  
...
![I tested the ADC and DAC with a multimeter and found that all the values differed.](/assets/images/esp32-adc-characterization/voltages.jpg)  
