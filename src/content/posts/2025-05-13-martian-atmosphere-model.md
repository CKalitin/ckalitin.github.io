...
![Image](/assets/images/martian-atmosphere-model/Perseverance.png)  
<i>([Expanded Image](/assets/images/martian-atmosphere-model/Perseverance.png)) This is one of the outputs of this project, a simulated entry of the Perseverance Mars rover compared to real data.</i>
...
![Image](/assets/images/martian-atmosphere-model/FBD.png)  
...
![Image](/assets/images/martian-atmosphere-model/Drag-formula.jpg)  
...
![Image](/assets/images/martian-atmosphere-model/Force-drag-formula.jpg)  

Acceleration due to gravity:  
![Image](/assets/images/martian-atmosphere-model/Force-gravity-formula.jpg)

Acceleration due to lift (same as before but with acceleration instead of force as the variables):  
(Lift/Drag Ratio) * Drag = Lift

![Image](/assets/images/martian-atmosphere-model/Simulation-Acceleration-Functions.jpg)
...
![Image](/assets/images/martian-atmosphere-model/Simulation-While-Loop.jpg)
...
![Image](/assets/images/martian-atmosphere-model/first-sim.png)  
<i>([Expanded Image](/assets/images/martian-atmosphere-model/first-sim.png)) This is [one of the first simulations](https://x.com/CKalitin/status/1920714814873129164) done using the model. (Shown using updated interface so that it's consistent with other charts in this post)</i>
...
![Image](/assets/images/martian-atmosphere-model/Convergence.jpg)  
...
![Image](/assets/images/martian-atmosphere-model/Opportunity.png)  
<i>([Expanded Image](/assets/images/martian-atmosphere-model/Opportunity.png)) This is my simulation of the Opportunity rover's Mars atmospheric entry.</i>
...
![Image](/assets/images/martian-atmosphere-model/Perseverance.png)  
<i>([Expanded Image](/assets/images/martian-atmosphere-model/Perseverance.png)) This is my simulation of the Perseverance rover's Mars atmospheric entry.</i>
...
![Image](/assets/images/martian-atmosphere-model/Elon-talk.jpg)
<i>([Expanded Image](/assets/images/martian-atmosphere-model/Elon-talk.jpg)) In a [2017 Starship talk](https://youtu.be/o7lBn93SxyE?si=aGaAdXPdI904-rYb&t=2016), Elon showed a simulated BFR Mars entry which I plotted my results against.</i>

![Image](/assets/images/martian-atmosphere-model/Starship.png)  
<i>([Expanded Image](/assets/images/martian-atmosphere-model/Starship.png)) See the top middle chart for comparison between my Model and SpaceX's higher fidelity simulation.</i>
