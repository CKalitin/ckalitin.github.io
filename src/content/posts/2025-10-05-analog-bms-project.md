...
<i><a href="/assets/images/analog-bms-project/PCB_schematic.jpg" target="_blank" rel="noopener">Expanded Schematic</a></i>
...
![Image](/assets/images/analog-bms-project/breadboard.jpg)
...
![Image](/assets/images/analog-bms-project/PCB_kicad_top_layer.png)  
<i><a href="/assets/images/analog-bms-project/PCB_kicad_top_layer.png" target="_blank" rel="noopener">Expanded Image</a></i>
...
![Image](/assets/images/analog-bms-project/module.JPG)
![Image](/assets/images/analog-bms-project/module_exploded.JPG)
...
![Image](/assets/images/analog-bms-project/reflow.jpg)
...
![Image](/assets/images/analog-bms-project/annotation.png)  
<i><a href="/assets/images/analog-bms-project/annotation.png" target="_blank" rel="noopener">Expanded Image</a>. Annotated trace voltages test data in firefox. <a href="https://github.com/CKalitin/analog-bms/tree/master/tests" target="_blank" rel="noopener">All available in the Git repo</a>.</i>
...
![Image](/assets/images/analog-bms-project/Rotated-FETs.jpg)    

Labelling trace voltages also helped me to figure out that [all my MOSFET footprints were incorrect](https://x.com/CKalitin/status/1969834710554779652). I used the built-in KiCAD libraries for MOSFET schematic symbols and footprints, and these are not consistent with each other. SOT-23 is not purely used for MOSFETs, so the pinout is not consistent.
...
![Image](/assets/images/analog-bms-project/ltspice.jpg)    
<i><a href="/assets/images/analog-bms-project/ltspice.jpg" target="_blank" rel="noopener">Expanded Image</a>. LTspice sim available in the <a href="https://github.com/CKalitin/analog-bms/tree/master/ltspice" target="_blank" rel="noopener">Git repo</a>.</i>
...
<i><a href="/assets/images/analog-bms-project/ov-divider-testing.jpg" target="_blank" rel="noopener">Expanded Image</a>. When plotting the OV voltage divider output for given input voltages, I did not get a linear response.</i>

![Image](/assets/images/analog-bms-project/ov-divider-testing-replaced-comparator-and-5k-10k-divider.jpg)  
<i><a href="/assets/images/analog-bms-project/ov-divider-testing-replaced-comparator-and-5k-10k-divider.jpg" target="_blank" rel="noopener">Expanded Image</a>. After replacing the comparator and using 5k/10k voltage divider (instead of 500k/1M), I got a linear response.</i>
...
![Image](/assets/images/analog-bms-project/led.jpg)  
